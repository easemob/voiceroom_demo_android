package com.easemob.chatroom.controller

import android.content.Context
import com.easemob.buddy.tool.ThreadManager
import com.easemob.chatroom.BuildConfig
...
import com.easemob.secnceui.bean.SoundAudioBean
...
class RtcRoomController : IRtcKitListener {
     ...
     * 降噪控制
     */
    fun deNoise(anisModeBean: com.easemob.secnceui.bean.AINSModeBean) {
