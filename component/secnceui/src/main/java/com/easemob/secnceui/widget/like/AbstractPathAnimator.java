 ...
 */
package com.easemob.secnceui.widget.like;
...
public abstract class AbstractPathAnimator {
    ...
    public static class Config {
        ...
        static public Config fromTypeArray(TypedArray typedArray, float x, float y, int pointx, int heartWidth, int heartHeight) {
            ...
            config.initX = (int) typedArray.getDimension(R.styleable.LikeLayout_initX,
                    x);
            config.initY = (int) typedArray.getDimension(R.styleable.LikeLayout_initY,
                    y);
            config.xRand = (int) typedArray.getDimension(R.styleable.LikeLayout_xRand,
                    res.getDimensionPixelOffset(R.dimen.like_anim_bezier_x_rand));
            config.animLength = (int) typedArray.getDimension(R.styleable.LikeLayout_animLength,
                    res.getDimensionPixelOffset(R.dimen.like_anim_length));//动画长度
...
//                    res.getDimensionPixelOffset(R.dimen.heart_size_height));//动画图片高度
            ...
            config.animDuration = typedArray.getInteger(R.styleable.LikeLayout_anim_duration,
