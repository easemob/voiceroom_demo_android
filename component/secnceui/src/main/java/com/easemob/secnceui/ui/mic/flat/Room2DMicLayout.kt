...
import com.easemob.secnceui.databinding.ViewChatroom2dMicLayoutBinding
...
class Room2DMicLayout : ConstraintLayout, IRoomMicView {
    ...
    fun setUpAdapter(isUseBot: Boolean) {
        ...
        binding.rvChatroomMicLayout.apply {
            ...
            addItemDecoration(MaterialDividerItemDecoration(context, MaterialDividerItemDecoration.VERTICAL).apply {
                ...
                dividerColor = ResourcesTools.getColor(context.resources, com.easemob.baseui.R.color.transparent)
            })
    ...
    override fun receiverAttributeMap(newMicMap: Map<Int, com.easemob.secnceui.bean.MicInfoBean>) {
