package com.easemob.secnceui.widget.mic
...
import com.easemob.secnceui.databinding.ViewChatroom2dMicBinding
...
class Room2DMicView : ConstraintLayout ,IRoomMicBinding{
    ...
    override fun binding(micInfo: com.easemob.secnceui.bean.MicInfoBean) {
        mBinding.apply {
            if (micInfo.micStatus == com.easemob.secnceui.annotation.MicStatus.BotActivated || micInfo.micStatus == com.easemob.secnceui.annotation.MicStatus.BotInactive) { // 机器人
                ...
                ivMicTag.isVisible = micInfo.micStatus == com.easemob.secnceui.annotation.MicStatus.BotActivated
                mtMicRotActive.isGone = micInfo.micStatus == com.easemob.secnceui.annotation.MicStatus.BotActivated
                ivMicBotFloat.isGone = micInfo.micStatus == com.easemob.secnceui.annotation.MicStatus.BotActivated
            } else {
            ...
            if (micInfo.micStatus == com.easemob.secnceui.annotation.MicStatus.Normal || micInfo.micStatus == com.easemob.secnceui.annotation.MicStatus.BotActivated) {
                // 用户音量
