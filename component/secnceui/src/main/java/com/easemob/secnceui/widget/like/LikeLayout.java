...
public class LikeLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private static int[] drawableIds = new int[]{R.drawable.icon_like_1, R.drawable.icon_like_2, R.drawable.icon_like_3, R.drawable.icon_like_4, R.drawable.icon_like_5, R.drawable.icon_like_6};
