package com.easemob.secnceui.widget.titlebar;
 ...
 *
 */
public class ChatroomTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    public ChatroomTitleBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs){
        LayoutInflater.from(context).inflate(R.layout.widget_title_bar_layout, this);
