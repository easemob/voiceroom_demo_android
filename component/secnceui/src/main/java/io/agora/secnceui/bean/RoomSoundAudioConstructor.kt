...
object RoomSoundAudioConstructor {
    ...
    val createRoomSoundAudioMap: Map<Int, List<SoundAudioBean>> by lazy(LazyThreadSafetyMode.SYNCHRONIZED) {
        mutableMapOf(
            SoundAudioType.CreateCommonRoom to
            ...
            SoundAudioType.CreateSpatialRoom to
                    if (ResourcesTools.getIsZh()) mutableListOf(
                        SoundAudioBean(
                            SoundSpeakerType.BotBlue,
    ...
    val soundSelectionAudioMap: Map<Int, List<SoundAudioBean>> by lazy(LazyThreadSafetyMode.SYNCHRONIZED) {
        mutableMapOf(
            ...
            SoundAudioType.ProfessionalBroadcaster to
                    if (ResourcesTools.getIsZh()) mutableListOf(
                        SoundAudioBean(
                            SoundSpeakerType.BotRed,
